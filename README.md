...
Pi5 2gb or greater memory (with optional  RTC battery and active cooler)  
...
**if rechargeable RTC battery** then add "dtparam=rtc_bbat_vchg=3000000" to /boot/firmware/config.txt

**if wifi turn off power saver mode edit configuration:**
...
https://github.com/wkeeling63/racecam/releases/download/v1.0.1/racecam_1.0.1_arm64.deb
move package file to /tmp
sudo apt install /tmp/racecam_1.0.1_arm64.deb
